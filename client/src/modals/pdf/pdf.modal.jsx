        ...
        >
            <Box sx={styleModal} >
                ...
                <div style={{width: '100%', marginTop: 10, textAlign: 'center'}}>
                    ...
                    {!printing && <p style={{marginTop: 10, marginBottom: 0, fontSize: 26, color: '#888'}}>Descargar PDF</p>}
                    {printing && <p style={{marginTop: 10, marginBottom: 0, fontSize: 26, color: '#888'}}>Descargando...</p>}
                    </button>
                </div>
