...
router.post('/getReportByStateAndSite', ReportsService.getReportByStateAndSite)
...
router.post('/getAllReportsbySite', ReportsService.getAllReportsbySite)
...
router.post('/getReportsByDateRangeAndSite', ReportsService.getReportsByDateRangeAndSite)
